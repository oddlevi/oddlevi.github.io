<?php
// F-81 (Odd 13.09.2026): resultater fra Ruskamaraton Lapland, Levi, 12.09.2026.
// Kilden er Race Result (ikke EQ Timing som Skjervøy). Mellomtjener med filcache,
// så mange besøkende gir få kall mot raceresult.
//   ?visning=resultater           → alle deltakere i alle øvelser
//   ?visning=oppsett              → øvelser og antall
...
const EVENT = '374352';
const KONFIG = 'https://my.raceresult.com/' . EVENT . '/results/config?lang=fi&sanitize=true';
const REFERER = 'https://my.raceresult.com/' . EVENT . '/results?lang=fi';
$CACHE = sys_get_temp_dir() . '/treni_ruska_' . EVENT . '_';
...
function rader(): array {
    return cachet('resultater', 600, function () {
        ...
        $flat($d['data'], []);
        return ['hentet' => date('c'), 'lop' => 'Ruskamaraton Lapland', 'dato' => '2026-09-12',
                'sted' => 'Levi, Finland', 'antall' => count($ut), 'rader' => $ut];
    });
}
