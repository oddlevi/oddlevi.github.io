...
<header class="hero smal">
  ...
  <p class="reveal" style="font-size:1.15rem;line-height:1.5;max-width:38rem;margin:1.8rem 0 0"><b>Treni ser hver økt fra klokka di og planlegger treningsuka di etter hva du har gjort.</b><br>Gratis i testperioden.</p>
  <?php endif; ?>
</header>
