<?php
// treni.no/ig — landingssiden for bio-lenka på Instagram og Facebook.
//
...
$logg = dirname(__DIR__, 2) . '/ig_besok.jsonl';
...
<header class="hero smal">
  ...
  <h1 class="reveal" style="font-size:clamp(2rem,6vw,3rem)">Velkommen fra Instagram</h1>
...
<section class="ig-valg">
  <?php // 18.09: Northern Runners-kortet er tatt ut (B-127, sidene deaktivert). ?>
  <?php if (date('Y-m-d') <= '2026-09-14'): ?>
  <a class="ig-kort" href="/skjervoy/resultater/?fra=ig">
    <b>Skjervøy 20:1000, resultater →</b>
